...
const headCells = [
  { id: 'Fisrtname', numeric: false, disablePadding: true, label: 'Fisrtname' },
  { id: 'Lastname', numeric: true, disablePadding: false, label: 'Lastname' },
  { id: 'Card Price', numeric: true, disablePadding: false, label: 'Card Price' },
  { id: 'Diagnose', numeric: true, disablePadding: false, label: 'Diagnose' },
